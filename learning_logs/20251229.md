...
1. https://github.com
2. New 혹은 Create a repository 클릭
3. korit_12_java
4. Korea IT Academy 12월 국비과정 Java
5. 맨 밑으로 내려가서 create repository 버튼 클릭

6. git init
git config user.name "여러분깃허브아이디" 엔터
git config user.email "여러분@깃허브.이메일" 엔터
확인을 위해서
git config user.name
git config user.email을 했을 때 방금 입력한게 출력돼야 합니다.
git add .
git commit -m "feat: first commit"
git branch -M main
git remote add origin https://github.com/maybeags/korit_12_java_01.git
git push -u origin main

git add .
git commit -m "feat: 20251229 method / overloading / class / constructor"
git push

-> 자격 증명 삭제 / 자리 정리 / 키보드 마우스 정리하고 책상 위도 혹시 더러우면 닦아주세요
